...
let FindComponent = class extends React.Component {
  constructor(...args) {
    var _temp;
  ...
  render() {
    ...
    return React__default.createElement(this.props.component, { [this.props.name]: this.state.result });
  }
};
...
let FindAndSubscribeComponent = class extends React.Component {
  constructor(...args) {
    var _temp;
