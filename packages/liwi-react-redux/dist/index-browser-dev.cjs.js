...
var ComponentType = t.tdz(function () {
  return React.ComponentType;
});
var PropsType = t.type('PropsType', t.exactObject(t.property('component', t.ref(ComponentType)), t.property('loadingComponent', t.nullable(t.ref(ComponentType)), true), t.property('name', t.string()), t.property('query', t.ref(liwiStore.AbstractQuery))));
var FindComponent = (_temp2 = _class = function (_Component) {
  ...
  createClass(FindComponent, [{
    ...
    value: function render() {
      ...
      return _returnType.assert(React__default.createElement(this.props.component, defineProperty({}, this.props.name, this.state.result)));
    }
  }]);
  return FindComponent;
}(React.Component), _class.propTypes = t.propTypes(PropsType), _temp2);
...
var Props = t.type('Props', t.exactObject(t.property('component', t.ref(ComponentType$1)), t.property('loadingComponent', t.nullable(t.ref(ComponentType$1)), true), t.property('name', t.string()), t.property('query', t.ref(liwiStore.AbstractQuery))));
...
}(React.Component), _class$1.propTypes = t.propTypes(Props), _temp);
