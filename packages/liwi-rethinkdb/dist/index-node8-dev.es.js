...
import { AbstractConnection, AbstractQuery, AbstractStore, InsertType, UpdateType, ResultType } from 'liwi-store';
...
let RethinkStore = class extends AbstractStore {
  ...
  insertOne(object) {
    ...
    const _returnType2 = t.return(t.ref(ResultType$1));
  ...
  replaceOne(object) {
    ...
    const _returnType3 = t.return(t.ref(ResultType$1));
  ...
  upsertOne(object) {
    let _objectType3 = t.ref(UpdateType$1);
  ...
  replaceSeveral(objects) {
    ...
    const _returnType5 = t.return(t.array(t.ref(ResultType$1)));
  ...
  partialUpdateOne(object, partialUpdate) {
    ...
    const _returnType7 = t.return(t.ref(ResultType$1));
  ...
  findByKey(key) {
    ...
    const _returnType11 = t.return(t.nullable(t.ref(ResultType$1)));
