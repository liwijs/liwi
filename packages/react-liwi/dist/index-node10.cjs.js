...
const TransportClientContext = React.createContext(undefined);
const TransportClientStateContext = React.createContext('opening');
const TransportClientReadyContext = React.createContext(false);
