...
var Db = _interopDefault(require('mongodb/lib/db'));
var liwiStore = require('liwi-store');
var t = _interopDefault(require('flow-runtime'));
var Cursor = _interopDefault(require('mongodb/lib/cursor'));
var Collection = _interopDefault(require('mongodb/lib/collection'));

const logger = new Logger('liwi:mongo:MongoConnection');

let MongoConnection = class extends liwiStore.AbstractConnection {
...
let MongoCursor = class extends liwiStore.AbstractCursor {
...
const ResultType$1 = t.tdz(() => liwiStore.ResultType);
...
let MongoStore = class extends liwiStore.AbstractStore {
  ...
  insertOne(object) {
    ...
    const _returnType4 = t.return(t.ref(ResultType$1));
  ...
  replaceOne(object) {
    ...
    const _returnType5 = t.return(t.ref(ResultType$1));
  ...
  replaceSeveral(objects) {
    ...
    const _returnType7 = t.return(t.array(t.ref(ResultType$1)));
  ...
  async partialUpdateByKey(key, partialUpdate) {
    ...
    const _returnType = t.return(t.union(t.ref(ResultType$1), t.ref('Promise', t.ref(ResultType$1))));
  ...
  partialUpdateOne(object, partialUpdate) {
    let _objectType4 = t.ref(ResultType$1);

    let _partialUpdateType3 = t.ref(UpdateType);

    const _returnType8 = t.return(t.ref(ResultType$1));
  ...
  cursor(criteria, sort) {
    ...
    const _returnType11 = t.return(t.ref(MongoCursor, t.ref(ResultType$1)));
  ...
  findByKey(key) {
    ...
    const _returnType12 = t.return(t.nullable(t.ref(ResultType$1)));
  ...
  findOne(criteria, sort) {
    ...
    const _returnType13 = t.return(t.nullable(t.ref(ResultType$1)));
