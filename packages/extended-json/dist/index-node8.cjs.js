 ...
 * @return {string}
 */
var stringify = ((value, replacer, space) => JSON.stringify(value,
 ...
 * @return {*}
 */
var parse = ((text, reviver) => JSON.parse(text, reviver == null ? internalReviver : (key, value) => reviver(key, internalReviver(value))));
