...
var ChangeType = t.type('ChangeType', t.object(t.property('type', t.string()), t.property('state', t.nullable(t.string()), true), t.property('old_offset', t.nullable(t.number()), true), t.property('new_offset', t.nullable(t.number()), true), t.property('old_val', t.nullable(t.object()), true), t.property('new_val', t.nullable(t.object()), true)));
